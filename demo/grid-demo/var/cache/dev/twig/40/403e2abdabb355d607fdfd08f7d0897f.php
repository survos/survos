...
class __TwigTemplate_faae46861e8442b2a380252257193ab0 extends Template
{
    private $source;
    private $macros = [];
...
{% for breadcrumb in breadcrumbs|slice(1) %}
                        ...
                        {% endif %}
{% endfor %}
", "@SurvosBootstrap/components/menu_breadcrumb.html.twig", "/home/tac/ca/survos/demo/grid-demo/vendor/survos/bootstrap-bundle/templates/components/menu_breadcrumb.html.twig");
    }
}

...
class SurvosDatatablesBundle extends AbstractBundle
{
    ...
    public function loadExtension(array $config, ContainerConfigurator $container, ContainerBuilder $builder): void
    {
        ...
        if (class_exists(Environment::class) && class_exists(StimulusTwigExtension::class)) {
            $builder
                ->setDefinition('survos.datatables_bundle', new Definition(TwigExtension::class))
...
//            ->setArgument('$registry', new Reference('doctrine')) // should be optional
    ...
    public function configure(DefinitionConfigurator $definition): void
    {
        ...
        $definition->rootNode()
            ->children()
            ->scalarNode('stimulus_controller')->defaultValue('@survos/datatables-bundle/table')->end()

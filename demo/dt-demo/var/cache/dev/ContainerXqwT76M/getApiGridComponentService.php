...
class getApiGridComponentService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 6).'/packages/api-grid-bundle/src/Components/ApiGridComponent.php';
        include_once \dirname(__DIR__, 6).'/packages/api-grid-bundle/src/Service/DatatableService.php';

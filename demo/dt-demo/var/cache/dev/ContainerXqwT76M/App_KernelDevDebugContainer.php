...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 6).'/packages/api-grid-bundle/src/Twig/TwigExtension.php';
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/survos/grid-bundle/assets') => '@survos/grid', (\dirname(__DIR__, 4).'/vendor/survos/simple-datatables-bundle/assets') => '@survos/simple-datatables', (\dirname(__DIR__, 6).'/packages/api-grid-bundle/assets') => '@survos/api-grid', (\dirname(__DIR__, 4).'/vendor/survos/html-prettify-bundle/assets') => '@survos/html-prettyify', (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/assets') => '@survos/bootstrap', (\dirname(__DIR__, 4).'/vendor/survos/datatables-bundle/assets') => '@survos/datatables', (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', 'assets/' => '', (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/public') => 'bundles/survosbootstrap', (\dirname(__DIR__, 4).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/public') => 'bundles/apiplatform', (\dirname(__DIR__, 4).'/vendor/friendsofsymfony/jsrouting-bundle/Resources/public') => 'bundles/fosjsrouting'], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#']);
    }

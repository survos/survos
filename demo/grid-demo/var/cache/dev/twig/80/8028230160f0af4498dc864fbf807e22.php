...
class __TwigTemplate_d4cc53dd9a9b932ef85d6e19190c79eb extends Template
{
    private $source;
    private $macros = [];
...
{% for breadcrumb in breadcrumbs|slice(1) %}
                        ...
                        {% endif %}
{% endfor %}
", "@SurvosBootstrap/components/menu_breadcrumb.html.twig", "/home/tac/g/survos/survos/demo/grid-demo/vendor/survos/bootstrap-bundle/templates/components/menu_breadcrumb.html.twig");
    }
}

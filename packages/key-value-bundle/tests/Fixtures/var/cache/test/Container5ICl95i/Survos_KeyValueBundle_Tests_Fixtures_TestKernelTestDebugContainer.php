 ...
 */
class Survos_KeyValueBundle_Tests_Fixtures_TestKernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Survos\\KeyValueBundle\\Controller\\PixyController' => 'getPixyControllerService',
            'Survos\\KeyValueBundle\\Service\\SqliteService' => 'getSqliteServiceService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Survos\\KeyValueBundle\\Event\\CsvHeaderEvent', [#[\Closure(name: 'Survos\\KeyValueBundle\\EventListener\\CsvHeaderEventListener')] fn () => ($container->privates['Survos\\KeyValueBundle\\EventListener\\CsvHeaderEventListener'] ??= new \Survos\KeyValueBundle\EventListener\CsvHeaderEventListener()), 'onCsvHeaderEvent'], 0);
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['Survos\\KeyValueBundle\\Controller\\PixyController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Survos_KeyValueBundle_Tests_Fixtures_TestKernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SurvosKeyValueBundle' => 'Survos\\KeyValueBundle\\SurvosKeyValueBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'SurvosKeyValueBundle' => [
                    'path' => \dirname(__DIR__, 6),
                    'namespace' => 'Survos\\KeyValueBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Survos_KeyValueBundle_Tests_Fixtures_TestKernelTestDebugContainer',

...
class __TwigTemplate_e136a0d589d052d18e41d0b372a236b0 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["type"]) || array_key_exists("type", $context) ? $context["type"] : (function () { throw new RuntimeError('Variable "type" does not exist.', 27, $this->source); })()), ["footer"])) {
            // line 28
            echo "
        ";
            // line 29
...
(isset($context["type"]) || array_key_exists("type", $context) ? $context["type"] : (function () { throw new RuntimeError('Variable "type" does not exist.', 40, $this->source); })()), ["top_auth"])) {
            // line 41
            echo "        ";
...
(isset($context["type"]) || array_key_exists("type", $context) ? $context["type"] : (function () { throw new RuntimeError('Variable "type" does not exist.', 47, $this->source); })()), ["top_navbar", "top_page"])) {
            // line 48
            echo "        ";
...
{#    title: project.code #}
{#    } #}
", "@SurvosBootstrap/components/menu.html.twig", "/home/tac/ca/survos/demo/grid-demo/vendor/survos/bootstrap-bundle/templates/components/menu.html.twig");
    }
}

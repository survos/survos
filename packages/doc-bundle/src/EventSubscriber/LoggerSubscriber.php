...
// was codeception, now https://docs.phpunit.de/en/12.0/events.html#test
...
//        assert(false);
    ...
    public static $events = [
        PreparationStarted::class => 'onPreparationStarted',
    ];
...
//     * @var Step[]
    ...
    public function onPreparationStarted(PreparationStarted $e)
    {
                dd(false, $e::class);
    }
...
//    public function beforeTest(Test $e)
//    {
//        $this->steps = [];

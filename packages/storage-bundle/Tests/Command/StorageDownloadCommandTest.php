<?php
namespace Survos\StorageBundle\Tests\Command;
...
class StorageDownloadCommandTest extends KernelTestCase
{
    ...
    public function testExecute(): void
    {
        ...
        $command = $application->find('storage:download');
        ...
        $this->assertStringContainsString('storage:download: downloaded to', $output);
    ...
    public function testUnzipExecute(): void
    {
        ...
        $commandTester->assertCommandIsSuccessful();
        $output = $commandTester->getDisplay();
        $this->assertStringContainsString('storage:download: downloaded', $output);

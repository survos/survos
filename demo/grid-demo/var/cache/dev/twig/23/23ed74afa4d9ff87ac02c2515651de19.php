...
class __TwigTemplate_49e6eae893b232c5db2481c9cac5dad4 extends Template
{
    private $source;
    private $macros = [];
...
$this->getTemplateName(), "columns" => twig_array_merge([0 => "id", 1 => "firstName", 2 => "lastName", 3 => "officialName"], (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) ? ([0 => "actions"]) : ([0 => "birthday"])))]), $context);
        $this->loadTemplate("congress/browse.html.twig", "congress/browse.html.twig", 13, "1248006283")->display($props);
        // line 37
        echo "
";
...
/* congress/browse.html.twig */
class __TwigTemplate_49e6eae893b232c5db2481c9cac5dad4___1248006283 extends Template
{
    private $source;
    private $macros = [];

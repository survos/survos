...
class __TwigTemplate_3a1ec7686a9f0ebe2ad09d67044fd05d extends Template
{
    private $source;
    private $macros = [];
...
$this->getTemplateName(), "columns" => twig_array_merge([0 => "id", 1 => "firstName", 2 => "lastName", 3 => "officialName"], (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) ? ([0 => "actions"]) : ([0 => "birthday"])))]), $context);
        $this->loadTemplate("congress/browse.html.twig", "congress/browse.html.twig", 13, "546299953")->display($props);
        // line 37
        echo "
";
...
/* congress/browse.html.twig */
class __TwigTemplate_3a1ec7686a9f0ebe2ad09d67044fd05d___546299953 extends Template
{
    private $source;
    private $macros = [];

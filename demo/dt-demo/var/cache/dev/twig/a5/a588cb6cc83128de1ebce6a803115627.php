...
class __TwigTemplate_686bfb8c7f1d45effcecf177a2819e8a extends Template
{
    private $source;
    private $macros = [];
...
{% for breadcrumb in breadcrumbs|slice(1) %}
                        ...
                        {% endif %}
{% endfor %}
", "@SurvosBootstrap/components/menu_breadcrumb.html.twig", "/home/tac/ca/survos/demo/dt-demo/vendor/survos/bootstrap-bundle/templates/components/menu_breadcrumb.html.twig");
    }
}

...
class getAnnotatedAppEntityOfficialApiPlatformDoctrineOrmFilterOrderFilterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_official_api_platform_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\OrderFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), 'order', ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['firstName' => NULL, 'lastName' => NULL, 'gender' => NULL, 'birthDay' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)), NULL);
    }
}

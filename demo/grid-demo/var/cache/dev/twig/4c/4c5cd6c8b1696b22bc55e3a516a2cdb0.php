...
class __TwigTemplate_566c51816fb69a58ca72e61ee779faec extends Template
{
    private $source;
    private $macros = [];
...
{% macro session_flash(close, use_raw, class, domain) %}
    ...
    {% endif %}
{% endmacro %}
", "@SurvosBootstrap/macros/flash_messages.html.twig", "/home/tac/ca/survos/packages/bootstrap-bundle/templates/macros/flash_messages.html.twig");
    }
}

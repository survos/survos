...
class __TwigTemplate_0f5885109b613b23ad6681a82e1f5224 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 37
        $preRendered = $this->extensions["Symfony\\UX\\TwigComponent\\Twig\\ComponentExtension"]->preRender("grid", twig_to_array(["data" => twig_get_attribute($this->env, $this->source,         // line 38
(isset($context["official"]) || array_key_exists("official", $context) ? $context["official"] : (function () { throw new RuntimeError('Variable "official" does not exist.', 38, $this->source); })()), "terms", [], "any", false, false, false, 38), "columns" => ["type", "party", ["name" => "stateAbbreviation", "title" => "State"], "district", ["name" => "startDatex"], ["name" => "endDatex"]]]));
        if (null !== $preRendered) {
            echo $preRendered;
        } else {
            $embeddedContext = $this->extensions["Symfony\\UX\\TwigComponent\\Twig\\ComponentExtension"]->embeddedContext("grid", twig_to_array(["data" => twig_get_attribute($this->env, $this->source, (isset($context["official"]) || array_key_exists("official", $context) ? $context["official"] : (function () { throw new RuntimeError('Variable "official" does not exist.', 38, $this->source); })()), "terms", [], "any", false, false, false, 38), "columns" => ["type", "party", ["name" => "stateAbbreviation", "title" => "State"], "district", ["name" => "startDatex"], ["name" => "endDatex"]]]), $context, "congress/show.html.twig", 40350368961);
            $embeddedBlocks = $embeddedContext["outerBlocks"]->convert($blocks, 40350368961);
            $this->loadTemplate("congress/show.html.twig", "congress/show.html.twig", 37, "40350368961")->display($embeddedContext, $embeddedBlocks);
...
";
    ...
    {
        return array (  150 => 57,  140 => 38,  139 => 37,  131 => 32,  124 => 28,  117 => 24,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "congress/show.html.twig", "/home/tac/ca/survos/demo/grid-demo/templates/congress/show.html.twig");
    }
}


/* congress/show.html.twig */
class __TwigTemplate_0f5885109b613b23ad6681a82e1f5224___40350368961 extends Template
{
    private $source;
    private $macros = [];
    ...
    /**     * @codeCoverageIgnore     */    public function getDebugInfo()
    {
        return array (  335 => 52,  325 => 51,  312 => 49,  302 => 48,  262 => 37,  150 => 57,  140 => 38,  139 => 37,  131 => 32,  124 => 28,  117 => 24,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }

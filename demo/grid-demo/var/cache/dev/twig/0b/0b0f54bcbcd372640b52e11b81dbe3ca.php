...
class __TwigTemplate_2883aa8533edb8185962c75df9986ad4 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 13
        $preRendered = $this->extensions["Symfony\\UX\\TwigComponent\\Twig\\ComponentExtension"]->preRender("api_grid", twig_to_array(["class" =>         // line 14
...
$this->getTemplateName(), "columns" => twig_array_merge(["id", "firstName", "lastName", "officialName"], (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) ? (["actions"]) : (["birthday"])))]));
        if (null !== $preRendered) {
            echo $preRendered;
        } else {
            $embeddedContext = $this->extensions["Symfony\\UX\\TwigComponent\\Twig\\ComponentExtension"]->embeddedContext("api_grid", twig_to_array(["class" =>             // line 14
(isset($context["class"]) || array_key_exists("class", $context) ? $context["class"] : (function () { throw new RuntimeError('Variable "class" does not exist.', 14, $this->source); })()), "caller" =>             // line 15
$this->getTemplateName(), "columns" => twig_array_merge(["id", "firstName", "lastName", "officialName"], (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) ? (["actions"]) : (["birthday"])))]), $context, "congress/browse.html.twig", 11248508661);
            $embeddedBlocks = $embeddedContext["outerBlocks"]->convert($blocks, 11248508661);
            $this->loadTemplate("congress/browse.html.twig", "congress/browse.html.twig", 13, "11248508661")->display($embeddedContext, $embeddedBlocks);
...
";
    ...
    {
        return array (  114 => 37,  108 => 15,  107 => 14,  102 => 15,  101 => 14,  100 => 13,  97 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "congress/browse.html.twig", "/home/tac/ca/survos/demo/grid-demo/templates/congress/browse.html.twig");
    }
}


/* congress/browse.html.twig */
class __TwigTemplate_2883aa8533edb8185962c75df9986ad4___11248508661 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function getDebugInfo()
    {
        return array (  308 => 33,  298 => 32,  285 => 29,  275 => 28,  262 => 24,  257 => 23,  247 => 22,  207 => 13,  114 => 37,  108 => 15,  107 => 14,  102 => 15,  101 => 14,  100 => 13,  97 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }

 ...
 */
class getArgumentResolver_NotTaggedControllerService extends Survos_KeyValueBundle_Tests_Fixtures_TestKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($container->privates['.service_locator.tDsuIE_'] ?? $container->load('get_ServiceLocator_TDsuIEService')));
    }
}

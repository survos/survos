...
class __TwigTemplate_af7654a5cdbb90741ba2dbe5bc574b2f extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        ";
        // line 6
        echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusController($this->env, (isset($context["_controller"]) || array_key_exists("_controller", $context) ? $context["_controller"] : (function () { throw new RuntimeError('Variable "_controller" does not exist.', 6, $this->source); })()));
        echo "
>
    <div         ";
        // line 8
        echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusTarget($this->env, (isset($context["_controller"]) || array_key_exists("_controller", $context) ? $context["_controller"] : (function () { throw new RuntimeError('Variable "_controller" does not exist.', 8, $this->source); })()), "modal");
        echo ">Modal</div>

    <table class=\"table\" ";
        // line 10
        echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusTarget($this->env, (isset($context["_controller"]) || array_key_exists("_controller", $context) ? $context["_controller"] : (function () { throw new RuntimeError('Variable "_controller" does not exist.', 10, $this->source); })()), "table");
        echo ">
        <thead>
        <tr>
            ";
...
<td>
    ...
    {% endblock %}
", "@SurvosGrid/_html_table.html.twig", "/home/tac/g/survos/survos/demo/grid-demo/vendor/survos/grid-bundle/templates/_html_table.html.twig");
    }
}

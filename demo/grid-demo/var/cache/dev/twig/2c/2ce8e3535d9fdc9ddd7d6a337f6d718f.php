...
class __TwigTemplate_aa26c5a384b42e45b0a19cc49c884ea3 extends Template
{
    private $source;
    private $macros = [];
...
{% macro session_flash(close, use_raw, class, domain) %}
    ...
    {% endif %}
{% endmacro %}
", "@SurvosBootstrap/macros/flash_messages.html.twig", "/home/tac/g/survos/survos/demo/grid-demo/vendor/survos/bootstrap-bundle/templates/macros/flash_messages.html.twig");
    }
}

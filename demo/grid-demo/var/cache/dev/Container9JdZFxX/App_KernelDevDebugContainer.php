...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', (\dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle/assets') => '@survos/api-grid', (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/assets') => '@survos/bootstrap', (\dirname(__DIR__, 4).'/vendor/survos/grid-bundle/assets') => '@survos/grid', 'assets/' => '', 'vendor/friendsofsymfony/jsrouting-bundle/Resources/' => '', (\dirname(__DIR__, 4).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/public') => 'bundles/apiplatform', (\dirname(__DIR__, 4).'/vendor/friendsofsymfony/jsrouting-bundle/Resources/public') => 'bundles/fosjsrouting', (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/public') => 'bundles/survosbootstrap'], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#']);
    }

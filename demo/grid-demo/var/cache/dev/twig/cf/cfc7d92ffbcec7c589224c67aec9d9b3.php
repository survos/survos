...
class __TwigTemplate_42a22e3d9d42acfb77848b22d4bad705 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 16
        $context["locale"] = ((twig_get_attribute($this->env, $this->source, (isset($context["this"]) || array_key_exists("this", $context) ? $context["this"] : (function () { throw new RuntimeError('Variable "this" does not exist.', 16, $this->source); })()), "locale", [], "any", false, false, false, 16)) ?: (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "request", [], "any", false, false, false, 16), "locale", [], "any", false, false, false, 16)) ?: ("xx"))));
        // line 17
        echo "
";
        // line 18
...
", "@SurvosApiGrid/components/api_grid.html.twig", "/home/tac/ca/survos/demo/grid-demo/vendor/survos/api-grid-bundle/templates/components/api_grid.html.twig");
    }
}

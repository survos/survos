 ...
 */
class Survos_GeoapifyBundle_Tests_Service_GeoapifyBundleClientTestKernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'survos_geoapify_service' => 'getSurvosGeoapifyServiceService',
        ];
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                'SurvosGeoapifyBundle' => 'Survos\\GeoapifyBundle\\SurvosGeoapifyBundle',
            ],
            'kernel.bundles_metadata' => [
                'SurvosGeoapifyBundle' => [
                    'path' => \dirname(__DIR__, 5),
                    'namespace' => 'Survos\\GeoapifyBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Survos_GeoapifyBundle_Tests_Service_GeoapifyBundleClientTestKernelTestDebugContainer',
        ];
    }
}

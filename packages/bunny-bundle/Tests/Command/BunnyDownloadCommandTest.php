<?php
namespace Survos\BunnyBundle\Tests\Command;
...
class BunnyDownloadCommandTest extends KernelTestCase
{
    ...
    public function testExecute(): void
    {
        ...
        $command = $application->find('bunny:download');
        ...
        $this->assertStringContainsString('bunny:download: downloaded to', $output);
    ...
    public function testUnzipExecute(): void
    {
        ...
        $commandTester->assertCommandIsSuccessful();
        $output = $commandTester->getDisplay();
        $this->assertStringContainsString('bunny:download: downloaded', $output);

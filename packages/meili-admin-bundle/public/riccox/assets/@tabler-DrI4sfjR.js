import{r as v}from"./react-DLE0P_Nq.js";const M="modulepreload",m=function(h){return"/meiliAdmin/riccox/"+h},y={},w=function(d,r,p){let s=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),a=(t==null?void 0:t.nonce)||(t==null?void 0:t.getAttribute("nonce"));s=Promise.allSettled(r.map(o=>{if(o=m(o),o in y)return;y[o]=!0;const l=o.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${c}`))return;const n=document.createElement("link");if(n.rel=l?"stylesheet":M,l||(n.as="script"),n.crossOrigin="",n.href=o,a&&n.setAttribute("nonce",a),document.head.appendChild(n),l)return new Promise((k,g)=>{n.addEventListener("load",k),n.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${o}`)))})}))}function i(t){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=t,window.dispatchEvent(a),!a.defaultPrevented)throw t}return s.then(t=>{for(const a of t||[])a.status==="rejected"&&i(a.reason);return d().catch(i)})};/**
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const e=(h,d,r,p)=>{const s=v.forwardRef(({color:i="currentColor",size:t=24,stroke:a=2,title:o,className:l,children:c,...n},k)=>v.createElement("svg",{ref:k,...I[h],width:t,height:t,className:["tabler-icon",`tabler-icon-${d}`,l].join(" "),strokeWidth:a,stroke:i,...n},[o&&v.createElement("title",{key:"svg-title"},o),...p.map(([g,u])=>v.createElement(g,u)),...Array.isArray(c)?c:[c]]));return s.displayName=`${r}`,s};/**
 * @license @tabler/icons-react v3.19.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.

...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'survos_scraper.scraper_service' => 'getSurvosScraper_ScraperServiceService',
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\TermCrudController' => 'getTermCrudControllerService',
            'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController' => 'getProfilerControllerService',
            'Survos\\ApiGrid\\State\\MeiliSearchStateProvider' => 'getMeiliSearchStateProviderService',
            'Survos\\AuthBundle\\Controller\\OAuthController' => 'getOAuthControllerService',
            ...
            'gajus_indenter' => 'getGajusIndenterService',
            'knp_menu.factory' => 'getKnpMenu_FactoryService',
            'knpu.oauth2.registry' => 'getKnpu_Oauth2_RegistryService',
            'monolog.logger.deprecation' => 'getMonolog_Logger_DeprecationService',
            'routing.loader' => 'getRouting_LoaderService',
            'services_resetter' => 'getServicesResetterService',
            'survos_auth.base_service' => 'getSurvosAuth_BaseServiceService',
            'survos_scraper.cache_scraper_service' => 'getSurvosScraper_CacheScraperServiceService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Serializer/Normalizer/SkippingInstantiatedObjectDenormalizer.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle/src/Hydra/Serializer/DataTableCollectionNormalizer.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Decoder/MarkdownDecoder.php';
            include_once \dirname(__DIR__, 4).'/vendor/erusev/parsedown/Parsedown.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Service/Parsedown.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Decoder/HtmlDecoder.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/survos/datatables-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/knplabs/knp-menu/src/Knp/Menu/Twig/MenuExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/src/Service/ContextService.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/html-prettify-bundle/src/Twig/HtmlPrettifyExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/auth-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/inspection-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/scraper-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/simple-datatables-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/survos/grid-bundle/src/Twig/TwigExtension.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Twig/ContentExtension.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/survos/scraper-bundle/src/Service/ScraperService.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Builder/PageList.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Builder/Sitemap.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/EventListener/SitemapListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/EventListener/Informator.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Routing/UrlGenerator.php';
            include_once \dirname(__DIR__, 4).'/vendor/stenope/stenope/src/Routing/RouteInfoCollection.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QmE8ZeMCAc', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CostoAvzYB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lrft7-0S7l', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $c = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity'), (\dirname(__DIR__, 4).'/vendor/survos/core-bundle/src/Entity')], true));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('sidebar_menu', [#[\Closure(name: 'App\\EventListener\\AppMenuMenuEventListener')] fn () => ($container->privates['App\\EventListener\\AppMenuMenuEventListener'] ?? $container->load('getAppMenuMenuEventListenerService')), 'sidebarMenu'], 0);
        $instance->addListener('page_menu', [#[\Closure(name: 'App\\EventListener\\AppMenuMenuEventListener')] fn () => ($container->privates['App\\EventListener\\AppMenuMenuEventListener'] ?? $container->load('getAppMenuMenuEventListenerService')), 'pageMenu'], 0);
        $instance->addListener('survos_navbar_menu', [#[\Closure(name: 'App\\EventListener\\AppMenuMenuEventListener')] fn () => ($container->privates['App\\EventListener\\AppMenuMenuEventListener'] ?? $container->load('getAppMenuMenuEventListenerService')), 'navbarMenu'], 0);
        ...
        $instance->addListener('kernel.terminate', [#[\Closure(name: 'Stenope\\Bundle\\Highlighter\\Prism')] fn () => ($container->privates['Stenope\\Bundle\\Highlighter\\Prism'] ?? $container->load('getPrismService')), 'stop'], 0);
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'Stenope\\Bundle\\EventListener\\SitemapListener')] fn () => ($container->privates['Stenope\\Bundle\\EventListener\\SitemapListener'] ?? self::getSitemapListenerService($container)), 'onKernelResponse'], 0);
        $instance->addListener('kernel.request', [#[\Closure(name: 'Stenope\\Bundle\\EventListener\\Informator')] fn () => ($container->privates['Stenope\\Bundle\\EventListener\\Informator'] ?? self::getInformatorService($container)), 'onRequest'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController']);
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel($a, new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver($b, $c), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.value_resolver.Stenope\\Bundle\\HttpKernel\\Controller\\ArgumentResolver\\ContentArgumentResolver'] ?? $container->load('getContentArgumentResolverService'));
            ...
            'Stenope\\Bundle\\HttpKernel\\Controller\\ArgumentResolver\\ContentArgumentResolver' => ['privates', '.debug.value_resolver.Stenope\\Bundle\\HttpKernel\\Controller\\ArgumentResolver\\ContentArgumentResolver', 'getContentArgumentResolverService', true],
            ...
            'Stenope\\Bundle\\HttpKernel\\Controller\\ArgumentResolver\\ContentArgumentResolver' => '?',
    ...
    /**
     * Gets the public 'survos_scraper.scraper_service' shared autowired service.
     *
     * @return \Survos\Scraper\Service\ScraperService
     */
    protected static function getSurvosScraper_ScraperServiceService($container)
    {
        return $container->services['survos_scraper.scraper_service'] = new \Survos\Scraper\Service\ScraperService('/tmp/cache', ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), ($container->services['cache.app'] ?? self::getCache_AppService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), '', 'scraper.sqlite');
    }
    ...
    {
        $a = ($container->privates['translator.default'] ?? self::getTranslator_DefaultService($container));

        if (isset($container->services['translator'])) {
            return $container->services['translator'];
        }

        return $container->services['translator'] = new \Symfony\Component\Translation\DataCollectorTranslator($a);
    }
    ...
    /**
     * Gets the private 'Stenope\Bundle\EventListener\Informator' shared service.
     *
     * @return \Stenope\Bundle\EventListener\Informator
     */
    protected static function getInformatorService($container)
    {
        $a = ($container->privates['twig'] ?? self::getTwigService($container));

        if (isset($container->privates['Stenope\\Bundle\\EventListener\\Informator'])) {
            return $container->privates['Stenope\\Bundle\\EventListener\\Informator'];
        }

        return $container->privates['Stenope\\Bundle\\EventListener\\Informator'] = new \Stenope\Bundle\EventListener\Informator(($container->privates['Stenope\\Bundle\\Routing\\UrlGenerator'] ?? self::getUrlGeneratorService($container)), $a);
    }

    /**
     * Gets the private 'Stenope\Bundle\EventListener\SitemapListener' shared service.
     *
     * @return \Stenope\Bundle\EventListener\SitemapListener
     */
    protected static function getSitemapListenerService($container)
    {
        return $container->privates['Stenope\\Bundle\\EventListener\\SitemapListener'] = new \Stenope\Bundle\EventListener\SitemapListener(($container->privates['Stenope\\Bundle\\Routing\\RouteInfoCollection'] ?? self::getRouteInfoCollectionService($container)), ($container->privates['Stenope\\Bundle\\Builder\\Sitemap'] ??= new \Stenope\Bundle\Builder\Sitemap()));
    }

    /**
     * Gets the private 'Stenope\Bundle\Routing\RouteInfoCollection' shared service.
     *
     * @return \Stenope\Bundle\Routing\RouteInfoCollection
     */
    protected static function getRouteInfoCollectionService($container)
    {
        return $container->privates['Stenope\\Bundle\\Routing\\RouteInfoCollection'] = new \Stenope\Bundle\Routing\RouteInfoCollection(($container->services['router'] ?? self::getRouterService($container)));
    }

    /**
     * Gets the private 'Stenope\Bundle\Routing\UrlGenerator' shared service.
     *
     * @return \Stenope\Bundle\Routing\UrlGenerator
     */
    protected static function getUrlGeneratorService($container)
    {
        return $container->privates['Stenope\\Bundle\\Routing\\UrlGenerator'] = new \Stenope\Bundle\Routing\UrlGenerator(($container->privates['Stenope\\Bundle\\Routing\\RouteInfoCollection'] ?? self::getRouteInfoCollectionService($container)), ($container->services['router'] ?? self::getRouterService($container)), ($container->privates['Stenope\\Bundle\\Builder\\PageList'] ??= new \Stenope\Bundle\Builder\PageList()));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WoopPN35TA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kv+uE79bOi', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6vLjuh07+F', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getApiPlatform_Listener_Request_AddFormatService($container)
    {
        ...
        return $container->privates['api_platform.listener.request.add_format'] = new \ApiPlatform\Symfony\EventListener\AddFormatListener(($container->privates['api_platform.negotiator'] ??= new \Negotiation\Negotiator()), $a, $container->parameters['api_platform.formats'], $container->parameters['api_platform.error_formats'], $container->parameters['api_platform.docs_formats'], false);
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/survos/grid-bundle/assets') => '@survos/grid', (\dirname(__DIR__, 4).'/vendor/survos/simple-datatables-bundle/assets') => '@survos/simple-datatables', (\dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle/assets') => '@survos/api-grid', (\dirname(__DIR__, 4).'/vendor/survos/html-prettify-bundle/assets') => '@survos/html-prettyify', (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/assets') => '@survos/bootstrap', (\dirname(__DIR__, 4).'/vendor/survos/datatables-bundle/assets') => '@survos/datatables', (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', 'assets/' => '', (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/public') => 'bundles/survosbootstrap', (\dirname(__DIR__, 4).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/public') => 'bundles/apiplatform', (\dirname(__DIR__, 4).'/vendor/friendsofsymfony/jsrouting-bundle/Resources/public') => 'bundles/fosjsrouting'], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#']);
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sUxFWXYAcQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O23TzLFPoS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YaDiubyfjy', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wdBAeN0QUW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nxn97Joa+t', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pCOcLZBZp9', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jgShPNAwqs', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MpECcipNSk', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $j = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $g, $a)], [$i])));
        ...
        $p = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $m, $d, $n, $e, $g, $l, $o, [], $f);
        $q = new \ApiPlatform\Serializer\ItemNormalizer($c, $m, $d, $n, $g, $l, $o, NULL, $b, $f);
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $l, $g, $a, $s, NULL);
        $u = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Stenope\Bundle\Serializer\Normalizer\SkippingInstantiatedObjectDenormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($k, [], $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $m, $n, $k, $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $d, $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($k, true, [], $p), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, [], $q), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: $r), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($r), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ConstraintViolationListNormalizer([], $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $l, $a, $s, NULL)), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \Survos\ApiGrid\Hydra\Serializer\DataTableCollectionNormalizer($e, $n, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $d, NULL), 'page', 'pagination', $b, $g), $b, $n, ($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container))), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($t, $d, $e), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($t, $h)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder($i, $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder($u, $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $u), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Stenope\Bundle\Decoder\MarkdownDecoder(new \Stenope\Bundle\Service\Parsedown()), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Stenope\Bundle\Decoder\HtmlDecoder(), $h)]), $h);
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        $container->privates['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Translation\\ProfileTranslationLoader' => ['privates', 'App\\Translation\\ProfileTranslationLoader', 'getProfileTranslationLoaderService', true],
            ...
            'App\\Translation\\ProfileTranslationLoader' => '?',
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\RoutingExtension(($container->privates['Stenope\\Bundle\\Routing\\UrlGenerator'] ?? self::getUrlGeneratorService($container))));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\YamlExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\StopwatchExtension($a, true));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\ExpressionExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\HttpKernelExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\HttpFoundationExtension(new \Symfony\Component\HttpFoundation\UrlHelper($d, ($container->services['router'] ?? self::getRouterService($container)))));
        ...
        $instance->addExtension(new \Survos\Datatables\Twig\TwigExtension());
        ...
        $instance->addExtension(new \Survos\BootstrapBundle\Twig\TwigExtension(($container->privates['ux.twig_component.component_renderer'] ?? self::getUx_TwigComponent_ComponentRendererService($container)), ['home' => 'app_homepage', 'login' => 'app_login', 'homepage' => 'app_homepage', 'logout' => 'app_logout', 'offcanvas' => 'app_settings', 'register' => 'app_register'], ['layout_direction' => 'vertical', 'offcanvas' => 'end', 'theme' => 'bs5', 'allow_login' => false], new \Survos\BootstrapBundle\Service\ContextService(['layout_direction' => 'vertical', 'offcanvas' => 'end', 'theme' => 'bs5', 'allow_login' => false])));
        $instance->addExtension(new \Survos\HtmlPrettifyBundle\Twig\HtmlPrettifyExtension());
        $instance->addExtension(new \Survos\AuthBundle\Twig\TwigExtension());
        ...
        $instance->addExtension(new \Survos\ApiGrid\Twig\TwigExtension());
        $instance->addExtension(new \Survos\Scraper\Twig\TwigExtension(($container->services['survos_scraper.scraper_service'] ?? self::getSurvosScraper_ScraperServiceService($container))));
        $instance->addExtension(new \Survos\SimpleDatatables\Twig\TwigExtension());
        $instance->addExtension(new \Survos\Grid\Twig\TwigExtension(($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container))));
        $instance->addExtension(new \Stenope\Bundle\Twig\ContentExtension());
        ...
        $instance->addRuntimeLoader(new \Twig\RuntimeLoader\ContainerRuntimeLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'Stenope\\Bundle\\Twig\\ContentRuntime' => ['privates', 'Stenope\\Bundle\\Twig\\ContentRuntime', 'getContentRuntimeService', true],
        ], [
            ...
            'Stenope\\Bundle\\Twig\\ContentRuntime' => '?',
        ])));
    ...
    protected static function getTwig_Loader_NativeFilesystemService($container)
    {
        ...
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/symfony/ux-twig-component/templates'), '!TwigComponent');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/datatables-bundle/templates'), 'SurvosDatatables');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/datatables-bundle/templates'), '!SurvosDatatables');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/knplabs/knp-menu-bundle/src/Resources/views'), 'KnpMenu');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/knplabs/knp-menu-bundle/src/Resources/views'), '!KnpMenu');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/templates'), 'SurvosBootstrap');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle/templates'), '!SurvosBootstrap');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/views'), 'ApiPlatform');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/api-platform/core/src/Symfony/Bundle/Resources/views'), '!ApiPlatform');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/auth-bundle/templates'), 'SurvosAuth');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/auth-bundle/templates'), '!SurvosAuth');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle/templates'), 'SurvosApiGrid');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle/templates'), '!SurvosApiGrid');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/simple-datatables-bundle/templates'), 'SurvosSimpleDatatables');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/simple-datatables-bundle/templates'), '!SurvosSimpleDatatables');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/grid-bundle/templates'), 'SurvosGrid');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/survos/grid-bundle/templates'), '!SurvosGrid');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/stenope/stenope/templates'), 'Stenope');
        $instance->addPath((\dirname(__DIR__, 4).'/vendor/stenope/stenope/templates'), '!Stenope');
    ...
    protected static function getUx_TwigComponent_ComponentFactoryService($container)
    {
        ...
        return $container->privates['ux.twig_component.component_factory'] = new \Symfony\UX\TwigComponent\ComponentFactory(new \Symfony\UX\TwigComponent\ComponentTemplateFinder(($container->privates['twig.loader.native_filesystem'] ?? self::getTwig_Loader_NativeFilesystemService($container)), NULL), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'brand' => [false, 'Survos\\BootstrapBundle\\Components\\BrandComponent', 'getBrandComponentService', true],
            ...
            'simple_datatables' => [false, 'Survos\\SimpleDatatables\\Components\\SimpleDatatablesComponent', 'getSimpleDatatablesComponentService', true],
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SurvosDatatablesBundle' => 'Survos\\Datatables\\SurvosDatatablesBundle',
                'KnpMenuBundle' => 'Knp\\Bundle\\MenuBundle\\KnpMenuBundle',
                'SurvosBootstrapBundle' => 'Survos\\BootstrapBundle\\SurvosBootstrapBundle',
                'SurvosHtmlPrettifyBundle' => 'Survos\\HtmlPrettifyBundle\\SurvosHtmlPrettifyBundle',
                ...
                'SurvosAuthBundle' => 'Survos\\AuthBundle\\SurvosAuthBundle',
                ...
                'SurvosScraperBundle' => 'Survos\\Scraper\\SurvosScraperBundle',
                'SurvosSimpleDatatablesBundle' => 'Survos\\SimpleDatatables\\SurvosSimpleDatatablesBundle',
                'SurvosGridBundle' => 'Survos\\Grid\\SurvosGridBundle',
                'StenopeBundle' => 'Stenope\\Bundle\\StenopeBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'SurvosDatatablesBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/datatables-bundle'),
                ...
                'SurvosBootstrapBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/bootstrap-bundle'),
                    'namespace' => 'Survos\\BootstrapBundle',
                ],
                'SurvosHtmlPrettifyBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/html-prettify-bundle'),
                ...
                'SurvosAuthBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/auth-bundle'),
                ...
                'SurvosApiGridBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/api-grid-bundle'),
                    'namespace' => 'Survos\\ApiGrid',
                ],
                'SurvosScraperBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/scraper-bundle'),
                    'namespace' => 'Survos\\Scraper',
                ],
                'SurvosSimpleDatatablesBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/simple-datatables-bundle'),
                    'namespace' => 'Survos\\SimpleDatatables',
                ],
                'SurvosGridBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/survos/grid-bundle'),
                    'namespace' => 'Survos\\Grid',
                ],
                'StenopeBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/stenope/stenope'),

...
class __TwigTemplate_5d821dbec8ef346470b9ceccf8ebf3fb extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_toolbar($__form__ = null, $__tools__ = null, $__toolsRight__ = null, ...$__varargs__)
    {
        ...
        ";
            ...
            if ((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })())) {
                ...
                ";
                // line 14
                $this->env->getRuntime("Symfony\\Component\\Form\\FormRenderer")->setTheme((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), [0 => "form/toolbar-theme.html.twig"], true);
                // line 15
                echo "                ";
...
{% endmacro %}
", "@SurvosBootstrap/macros/toolbar.html.twig", "/home/tac/g/survos/survos/demo/grid-demo/vendor/survos/bootstrap-bundle/templates/macros/toolbar.html.twig");
    }
}
